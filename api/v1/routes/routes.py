...
from api.v1.routes.organizations.organization_router import router as organization_router
from api.v1.routes.projects.project_router import router as project_router
from api.v1.routes.tasks.task_router import router as task_router
from api.v1.routes.organizations.member_router import router as organization_member_router
from api.v1.routes.organizations.invite_router import router as organization_invite_router
from api.v1.routes.organizations.designation_router import router as designation_router
from api.v1.routes.projects.member_router import router as project_member_router
from api.v1.routes.projects.resource_router import router as project_resource_router
