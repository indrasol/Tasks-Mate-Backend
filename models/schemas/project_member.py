...
class ProjectMemberBase(BaseModel):
    ...
    created_by: Optional[UUID] = Field(None, description="Who created the membership")
    updated_by: Optional[UUID] = Field(None, description="Who last updated the membership")
