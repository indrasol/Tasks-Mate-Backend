...
class TaskAttachmentBase(BaseModel):
    ...
    uploaded_by: Optional[UUID] = Field(None, description="Who uploaded the attachment")
    ...
    deleted_by: Optional[UUID] = Field(None, description="Who deleted the attachment")
