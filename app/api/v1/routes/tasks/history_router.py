...
from app.models.schemas.task_history import TaskHistoryCreate, TaskHistoryUpdate, TaskHistoryInDB
from app.services.task_history_service import create_task_history, get_task_history, update_task_history, delete_task_history
